...
<section id="home-ctas">
	<div class="container">
		<div class="home-btns">
			<a href="formations.php"><button>Formateur Professionnel d'Adultes</button></a>
			<a href="financement.php"><button>Conseiller en Insertion Professionnelle</button></a>
		</div>
	</div>
</section>
...
<div class="inter-section">
	...
	<a href="#"><button>Mes options de financement</button></a>
</div>
...
<section id="formations">
	...
	<div class="formations-footer">
		<div class="f-footer-text">
			...
			<a href="financement.php"><button>En savoir plus</button></a>
		</div>
