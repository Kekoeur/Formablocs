...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 15 sep. 2021 à 00:11
...
INSERT INTO `toutes_formations` (`id`, `formation`, `price_id`, `link`) VALUES
(1, 'Formateur Professionnel d\'Adultes', 'price_1JXplgFXn081ePt8kRuMbLc7', 'forma1'),
(2, 'Conseiller en Insertion Professionnelle', 'price_1JXpnjFXn081ePt8bIZh09AL', 'forma2'),
(3, 'Préparer et animer des actions de formation collectives en intégrant des environnements numériques (bac+2)', 'price_1JXpvfFXn081ePt8tJKhH5XO', 'forma3'),
(4, 'Construire des parcours individualisés et  accompagner les apprenants (bac+2)', 'price_1JXpxeFXn081ePt8bkncllI1', 'forma4'),
(5, 'Accueillir pour analyser la demande des personnes et poser les bases d\'un diagnostic partagé (bac+2)\r\n', 'price_1JXq00FXn081ePt8nGT1NcVY', 'forma5'),
(6, 'Accompagner les personnes dans leur parcours d\'insertion sociale et professionnelle (bac+2)', 'price_1JXq1vFXn081ePt83mIsenWO', 'forma6'),
(7, 'Mettre en œuvre une offre de services auprès des employeurs pour  favoriser l\'insertion professionnelle) (bac+2)', 'price_1JXq2uFXn081ePt8cGdo9Yfr', 'forma7'),
(8, 'Digitalisation', 'price_1JXq6KFXn081ePt8FBVcufIG', 'Digitalisation'),
(9, 'Qualité', 'price_1JXq7XFXn081ePt8QgP49o76', 'quality'),
(10, 'RNCP', 'price_1JXq8MFXn081ePt8oeg5Taql', 'RNCP'),
(11, 'Ingénierie financière', 'price_1JXq96FXn081ePt8I9iEyOPP', 'inge'),
(12, 'Bilan pédagogique', 'price_1JXq9hFXn081ePt81CCe8hkY', 'bilan');
